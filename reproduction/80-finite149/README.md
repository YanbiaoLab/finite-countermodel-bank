...
CPython 3.9 or newer is sufficient; only the standard library is used.
...
The verifier rebuilds into a temporary directory, compares every generated byte,
reruns all exhaustive checks, validates every manifest hash, and finally invokes the
repository verifier for Stage 80 and its transitive dependencies.
