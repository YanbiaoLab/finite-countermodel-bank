...
- `submission-anchor.schema.json` describes each line of the Phase 0 submission index.
...
bytes. Phase 1 records also retain the historical compact-JSON table SHA-256 in the
