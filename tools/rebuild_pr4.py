#!/usr/bin/env python3
"""Rebuild PR 4's exact 1,487 payload and 2,901-table runtime closure."""
...
from tools.pr2_common import (  # noqa: E402
    ...
    manifest = {
        ...
        "sources": [
            ...
            },
            {
                ...
                "locator": "tools/pr4_common.py and tools/rebuild_pr4.py",
        ...
        "verification": {
            ...
            "command": "python3 tools/verify_pr4.py",
            "notes": [
                "The verifier rebuilds both PR 4 stages in a temporary directory, compares every generated byte, and runs the repository-level semantic checks."
            ],
        },
    }
...
def historical_runtime_reintroductions(
    ...
    """Find the earliest committed table record for derived bytes seen before PR 4."""
...
def build_stage100(
    ...
    manifest = {
        ...
        "verification": {
            ...
            "command": "python3 tools/verify_pr4.py",
            "notes": [
                "The verifier rebuilds both PR 4 stages in a temporary directory and compares every generated byte before repository-level transition checks."
            ],
        },
    }
    write_manifest(stage, artifacts, manifest)
